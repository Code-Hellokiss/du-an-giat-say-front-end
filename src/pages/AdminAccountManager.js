...
import {
    ...
    TableHead, TableRow, Paper, Button, Chip, Snackbar, Alert,
    useMediaQuery, Stack
} from '@mui/material';
                        ...
                        {users.map((user) => (
                            <Paper key={user.id} sx={{ p: 2 }}>
                                ...
                                <Typography variant="body2">
                                    Giới tính: {user.gender === true ? 'Nam' : user.gender === false ? 'Nữ' : 'Khác'}
                                </Typography>
                                ...
                                <Typography variant="body2" mb={1}>
                                    ...
                                    <Chip
                                        size="small"
                                        label={parseLocked(user.locked) ? 'Bị khóa' : 'Hoạt động'}
                                        color={parseLocked(user.locked) ? 'default' : 'success'}
                                    />
                                </Typography>
